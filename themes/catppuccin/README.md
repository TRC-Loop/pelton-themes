...
*Soothing pastel theme for Pelton*

| Field | Value |
| --- | --- |
| **Authors** | Catppuccin (ported by Arne K.) |
| **Licenses** | `MIT` |
| **Bases** | `dark`, `light` |
| **Flavors** | 4 |
...
| --- | --- | --- | --- | --- |
| Catppuccin Frappé | `1.0.8` | `dark` | Pelton `1.0.8` | `CatppuccinFrappe.peltontheme` |
| Catppuccin Latte | `1.0.8` | `light` | Pelton `1.0.8` | `CatppuccinLatte.peltontheme` |
| Catppuccin Macchiato | `1.0.8` | `dark` | Pelton `1.0.8` | `CatppuccinMacchiato.peltontheme` |
| Catppuccin Mocha | `1.0.8` | `dark` | Pelton `1.0.8` | `CatppuccinMocha.peltontheme` |
...
# 🐈 Catppuccin for Pelton

A soothing pastel theme for [Pelton](https://pelton.app), ported in all four official [Catppuccin](https://github.com/catppuccin/catppuccin) flavours: **Latte**, **Frappé**, **Macchiato**, and **Mocha**.
